...
<div class="bg-black">
    ...
    >
        <h2
            class="text-3xl font-extrabold tracking-tight text-white sm:text-4xl flex items-center"
        >
            <img class="h-20 mr-4" src="u-bile-ruze-logo.svg" alt="" />
            <div>
        ...
        <div class="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-3">
            ...
            >
                <div class="mb-12 space-y-4">
                    ...
                    <p class="mb-6">
                        Obcaecati, quam? Eligendi, nulla numquam natus laborum
                        porro at cum, consectetur ullam tempora ipsa iste
                        officia sed officiis! Incidunt ea animi officiis.
                    </p>
